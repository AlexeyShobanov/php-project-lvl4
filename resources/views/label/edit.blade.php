        ...
        <div class="container py-4">
            <div class="col-12 col-md-10 col-lg-8 mx-auto text-left text-dark">
                ...
                {{ Form::model($label, ['url' => route('labels.update', $label->id), 'class' => 'justify-content-center', 'method' => 'PATCH']) }}
                    ...
                    <x-form-drop-down-list label="{{ __('views.label.edit.color') }}" name="color_id" value="{{ $label->color_id }}" placeholder="{{ __('views.label.create.color') }}" :dataList="$colors" class="form-control form-control-lg"/>
